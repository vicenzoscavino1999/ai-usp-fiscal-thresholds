...
REFERENCE_CHANGELOG = [
    ...
    "Etapa 7.1: inversion de horizonte H* post-baseline; derivada de insumos firmados, sin recalibrar ni alterar resultados pre-registrados; PRIMARY_SPEC_HASH intacto.",
]
