...
actually exercised on 2026-07-10.
...
These are captured Make outputs, not examples:
...
- `make verify-freeze` exposes the primary-specification hash, 14 protected
...
be obtained by each reviewer through UNU-WIDER's registration process. Review of
the Ookla redistribution licence remains explicitly pending before any public
repository release; the raw tiles are not distributed here.
